...
int main(int argc, char** argv)
{
    ...
    while ((read = getline(&line, &len, stdin)) != -1) {
        ...
        update_last_gap(&my_pup_line,&last_gap_chrom,&last_gap_pos,&is_gap);
        //if position is gap delete in hindsight all potential mutations too close
        if( is_gap == 0 ){
            proximal_gap_hindsight_filter(potential_mut_lines,&mut_ptr,
        ...
        //if container full flush and print the accepted mutations
